...
int main() {
	...
	do {
		...
		while (fl && !(map2[0][0] == 'x'&& map2[0][2] == 'x'&& map2[0][4] == 'x' && map2[2][0] == 'x' && map2[2][2] == 'x' && map2[2][4] == 'x' && map2[4][0] == 'x' && map2[4][2] == 'x' && map2[4][4] == 'x') || (map2[0][0] == 'o'&& map2[0][2] == 'o'&& map2[0][4] == 'o' && map2[2][0] == 'o' && map2[2][2] == 'o' && map2[2][4] == 'o' && map2[4][0] == 'o' && map2[4][2] == 'o' && map2[4][4] == 'o')) {
			...
			cout << "Âû èãðàåòå çà êðåñòèêè \nÂâåäèòå íîìåð êëåòêè " << endl;
			cout << "Êàðòà " << endl;
			for (int i = 0; i < 5; i++)
			{
				for (int j = 0; j < 5; j++)
			...
			////////////////////////////////////////////////////////////////////////////////
			//Îòâåò êîìïüþòåðà (ðàíäîìíî âûáèðàåò ïîçèöèþ åñëè îíà íå çàíÿòà è ê ýòîìó ýëåìåíòó ìàññèâà ïðèñâàåâàåòñÿ íîëèê)
			bool flag = true;
			while (flag) {
				pc = 1 + rand() % 9;
				if (map2[0][0] == ' ' && pc == 1) {
